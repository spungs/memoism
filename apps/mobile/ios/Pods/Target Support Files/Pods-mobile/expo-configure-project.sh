...
with_node \
  ...
  --target "/Users/sonkyoungho/esc/Memoism/apps/mobile/ios/Pods/Target Support Files/Pods-mobile/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-file-system" "expo-image-picker" "expo-keep-awake"
