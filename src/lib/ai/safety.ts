 ...
 *
 * **번호·운영시간 변경 금지.** 2026-09-22 보건복지부 보건복지상담센터(129.go.kr/109)
 * 공식 안내로 확인했다:
 *   - 109        자살예방상담. 24시간, 무료. **2024-01-01부로 자살예방상담이 109로 통합**
 *                (옛 1393은 흡수됨).
 *   - 1577-0199  정신건강상담. 365일 24시간, 무료. 통합 후에도 담당 분야로 계속 운영.
 *
 * 129(보건복지상담센터 일반)·1388(청소년)·1366(여성)은 각자 담당이 따로 있어
 * 이 자리에 넣지 않는다. 실제로 펜스가 죽어 있던 동안 모델이 129·1388을 지어내
 * 답했다 — 그래서 이 문구가 상수여야 한다.
 */
